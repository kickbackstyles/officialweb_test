...
export default function Home(): JSX.Element {
  return (
    <>
      <Head>
        <title>Official Website | KickBackStyles</title>
        <meta name="description" content="KickBackStyles公式サイト | 4/1 21:00〜 初アイテム発売！ WAMLロングスリーブTシャツが登場。今ならShopify10名様限定40%オフセール実施中🔥 限定セールをお見逃しなく！" />
